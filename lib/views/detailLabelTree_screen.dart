...
class DetailLabelTreeScreen extends StatelessWidget {
  const DetailLabelTreeScreen({super.key});
                  ...
                  Expanded(
                    child: ListView(
                      children: [
                        ...
                        const SizedBox(height: 20),
                        labelTree.imageUrls != null &&
                                labelTree.imageUrls!.isNotEmpty
                            ? SizedBox(
                                height: 200,
                                ...
                                Navigator.of(context).push(
                                  MaterialPageRoute(
                                    builder: (_) => ChatBotScreen(
                                      initialMessage: 'Chào bạn, tôi cần thông tin về ${labelTree.name}',
                                      checkArrow: true,
                                    ),
                                  ),
                                );
