...
class AdminEditCategoryScreen extends StatefulWidget {
  ...
  const AdminEditCategoryScreen({super.key, required this.tree});
  ...
  void _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (_imageFile != null) {
        ...
        imageUrl = widget.tree.imageUrl;
      }

      try {
        if (imageUrl == null) {
          ToastUtils.showErrorToast("Ảnh không thể trống.");
          return;
        }
        if(mounted) {
          await Provider.of<TreeProvider>(context, listen: false).editTree(
            widget.tree.id,
            name,
            description,
            imageUrl,
        ...
        ToastUtils.showSuccessToast("Cập nhật loại cây thành công.");

        if (mounted) {
          Navigator.pop(context);
        }
      } catch (e) {
        ToastUtils.showErrorToast("Có lỗi xảy ra khi cập nhật thông tin cây.");
      }
    }
  }
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  "Hãy chỉnh sửa thông tin cây ${widget.tree.name}",
                ...
                Column(
                  ...
                  children: [
                    ...
                    if (_imageFile == null && widget.tree.imageUrl != null)
                      Center(
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(10),
                          child: Container(
